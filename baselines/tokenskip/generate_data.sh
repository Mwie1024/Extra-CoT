python longformer_tokenizer_compression.py \
  --input_path /data/tyt/workspace/tyt/Code/efficient_reasoning/TokenSkip-main/outputs/Qwen2.5-7B-Instruct/gsm8k/7b/Original/train/samples/predictions_formatted.jsonl \
