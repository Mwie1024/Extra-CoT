...
def main():
    ...
    ap.add_argument("--val-ratio", type=float, default=0.05, help="Validation split ratio (of kept items).")
    ap.add_argument("--val-per-ratio", default="20:40,40:40,60:40,80:40,100:40",
